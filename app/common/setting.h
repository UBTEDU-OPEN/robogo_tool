...
public:
    ...
    /**
     * @brief setMatrixAndCoef
     * @param matrix
     * @param coef
     * @return
     */
    bool setMatrixAndCoef(const QList<double> &matrix, const QList<double> &coef);

    /**
     * @brief restorMatrixAndCoef
     * @return
     */
    bool restorMatrixAndCoef();

    /**
     * @brief getCameraPicFolderPath
     * @return
     */
    QString getCameraPicFolderPath();

protected:
    Setting(const QString &fileName, QSettings::Format format, QObject *parent = nullptr);

private:
    QList<double> getFloatListValue(const QString &group, const QString &key);
